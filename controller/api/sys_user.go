...
const (
	USER_HEADER_IMG_PATH string = "https://uploadfile1.talkmate.com"
	USER_HEADER_BUCKET   string = "uploadfiles"
...
// @Security ApiKeyAuth
// @Produce  application/json
// @Param data body api.UserDeleteStutrc true "用户名称"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"成功"}"
// @Router /user/remove [post]
func UserRemove(c *gin.Context) {
	var params UserDeleteStutrc
	_ = c.BindJSON(&params)
	U := &sysModel.SysUser{UUID: uuid.FromStringOrNil(params.UUID)}
